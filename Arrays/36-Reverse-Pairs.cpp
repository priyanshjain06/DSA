...
// ANCHOR  we are altering (changing the value of) the original array . If we dont have to alter the array then we take a copy of it.

// LINK -  Time Complexity: O(2NlogN) and Space Complexity: O(N)
