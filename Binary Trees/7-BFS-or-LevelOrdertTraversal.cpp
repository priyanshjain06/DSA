...
public:
    ...
    vector<vector<int>> levelOrder(TreeNode *root) // REVIEW function
    {
        // REVIEW Create a 2D vector to store levels
        ...
        while (!q.empty())
        {
            ...
            for (int i = 0; i < size; i++)
            {
                ...
                level.push_back(node->val); // REVIEW
