...
private:
    ...
    bool isSymmetricUtil(Node *root1, Node *root2) //REVIEW 
    {
        ...
        return (root1->data == root2->data) && isSymmetricUtil(root1->left, root2->right) && isSymmetricUtil(root1->right, root2->left); //REVIEW 
    }

public:
    // Public function to check if the
    // entire binary tree is symmetric
    bool isSymmetric(Node *root) //REVIEW 
    {
